package com.example.laher.learnfractions.subtracting_similar;
...
public class SubtractingSimilarVideoActivity extends AppCompatActivity {
    //TOOLBAR
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SubtractingSimilarVideoActivity.this,
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SubtractingSimilarVideoActivity.this,
                        SubtractingSimilarExerciseActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
            }
        });
