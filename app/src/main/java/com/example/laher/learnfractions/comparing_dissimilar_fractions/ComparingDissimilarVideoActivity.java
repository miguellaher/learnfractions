...
import com.example.laher.learnfractions.comparing_similar_fractions.ComparingSimilarExercise2Activity;
import com.example.laher.learnfractions.comparing_similar_fractions.ComparingSimilarVideoActivity;

public class ComparingDissimilarVideoActivity extends AppCompatActivity {
    //TOOLBAR
    ...
    public void go(){
        ...
        video.requestFocus();
        video.start();
        video.setOnCompletionListener(new ComparingDissimilarVideoActivity.VideoOnCompletionListener());
    }
