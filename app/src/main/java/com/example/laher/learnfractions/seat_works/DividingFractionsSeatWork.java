...
public class DividingFractionsSeatWork extends SeatWork {
    ...
    public DividingFractionsSeatWork(String topicName) {
        super(topicName);
        String id = AppIDs.DFS;
        setId(id);
    ...
    public void setQuestions(){
        ...
        for(int i = 0; i < getItems_size(); i++){
            DividingFractionsQuestion question = new DividingFractionsQuestion(range);
            while (questions.contains(question)){
                question = new DividingFractionsQuestion(range);
            }
    ...
    public void setBtnChoices(){
        ...
        DividingFractionsQuestion question = questions.get(questionNum);
