package com.example.laher.learnfractions.multiplying_fractions;
...
public class MultiplyingFractionsVideoActivity extends AppCompatActivity {
    //TOOLBAR
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MultiplyingFractionsVideoActivity.this,
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MultiplyingFractionsVideoActivity.this,
                        MultiplyingFractionsExerciseActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
