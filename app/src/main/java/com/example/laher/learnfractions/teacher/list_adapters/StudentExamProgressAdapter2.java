...
public class StudentExamProgressAdapter2 extends ArrayAdapter<ExamStat> {
    ...
    public StudentExamProgressAdapter2(@NonNull Context context, int resource, ArrayList<ExamStat> examStats) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.textView2.setText("Score: " + score + " / " + getItem(position).getTotalItems());
