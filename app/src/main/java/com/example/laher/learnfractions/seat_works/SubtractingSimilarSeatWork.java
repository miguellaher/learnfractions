...
public class SubtractingSimilarSeatWork extends SeatWork {
    ...
    public SubtractingSimilarSeatWork(String topicName) {
        super(topicName);
        String id = AppIDs.SSS;
        setId(id);
    ...
    public SubtractingSimilarSeatWork(int size) {
        super(size);
        setTopicName(AppConstants.SUBTRACTING_SIMILAR);
        setSeatWorkNum(1);
    }
    ...
    public void setQuestions(){
        ...
        for(int i = 0; i < getItems_size(); i++){
            SubtractingSimilarFractionsQuestion question = new SubtractingSimilarFractionsQuestion(range);
            while (questions.contains(question)){
                question = new SubtractingSimilarFractionsQuestion(range);
            }
    ...
    public void setBtnChoices(){
        ...
        SubtractingSimilarFractionsQuestion question = questions.get(questionNum);
    ...
    public class BtnChoiceListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if (getCurrentItemNum()>getItems_size()){
                ...
                if (TYPE!=null) {
                    if (TYPE.equals(AppConstants.CHAPTER_EXAM)) {
                        AppCache.postSeatWorkStat(SubtractingSimilarSeatWork.this);
