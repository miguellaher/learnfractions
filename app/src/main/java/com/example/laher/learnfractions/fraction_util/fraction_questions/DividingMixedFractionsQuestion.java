...
public class DividingMixedFractionsQuestion extends FractionQuestionClass {
    ...
    public DividingMixedFractionsQuestion(String tag) {
    ...
    public DividingMixedFractionsQuestion(Range range) {
        super(range);
    ...
    public DividingMixedFractionsQuestion() {
        int randomNumber = (int) (Math.random() * 2 + 1);
        Range range = new Range();
        if (randomNumber==1){
            TAG = ONE_MIXED;
    ...
    private void generateOneMixedFractionEquation(Range range){
        ...
        int numeratorAnswer = numeratorImproper * denominator;
        int denominatorAnswer = denominatorImproper * numerator;
    ...
    private void generateTwoMixedFractionsEquation(Range range){
        ...
        int numeratorAnswer = numeratorImproper1 * denominatorImproper2;
        int denominatorAnswer = denominatorImproper1 * numeratorImproper2;
        Fraction fractionAnswer = new Fraction(numeratorAnswer, denominatorAnswer);
        setFractionAnswer(fractionAnswer);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DividingMixedFractionsQuestion){
            DividingMixedFractionsQuestion fractionsQuestion = (DividingMixedFractionsQuestion) obj;
