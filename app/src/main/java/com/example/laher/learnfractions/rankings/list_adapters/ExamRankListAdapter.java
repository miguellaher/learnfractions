...
public class ExamRankListAdapter extends ArrayAdapter<ExamStatAverage> {
    ...
    public ExamRankListAdapter(@NonNull Context context, int resource, ArrayList<ExamStatAverage> examStatAverages) {
        super(context, resource, examStatAverages);
        mContext = context;
        mResource = resource;
    }
