...
public class SeatworkStatAdapter extends ArrayAdapter<SeatWork> {
    private Context mContext;
    private int mResource;

    public SeatworkStatAdapter(@NonNull Context context, int resource, @NonNull ArrayList<SeatWork> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        int totalItems = seatWork.getItems_size();
        long time_spent = seatWork.getTimeSpent();
        ...
        holder.txtExerciseTitle.setText(topicName);
